...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_images', to='api.productimage'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['name', 'value'], name='api_product_name_b61153_idx')],
